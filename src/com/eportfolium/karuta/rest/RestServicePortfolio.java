...
public class RestServicePortfolio {
	...
	private final KEventbus eventbus = new KEventbus();
	...
	public RestServicePortfolio(@Context ServletConfig sc) {
		try {
			...
			archivePath = ConfigUtils.getInstance().getKarutaHome() +
					ConfigUtils.getInstance().getServletName() +
					"_archive" +
					File.separatorChar;
	...
	/**
	 * Delete a node DELETE /rest/api/nodes/node/{node-uuid} parameters: return:
	 **/
	@Path("/nodes/node/{node-uuid}")
	@DELETE
	@Produces(MediaType.APPLICATION_XML)
	public String deleteNode(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @QueryParam("userrole") String userrole,
			@PathParam("node-uuid") String nodeUuid, @Context ServletConfig sc,
	 ...
	 * /rest/api/portfoliogroups parameters: - group: group id - uuid: portfolio id
	 * return: Code 200
	 **/
	...
	/**
	 * Delete a resource DELETE /rest/api/resources/{resource-id} parameters:
	 * return:
	 **/
	...
	public String deleteResource(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @PathParam("resource-id") String resourceUuid, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest, @QueryParam("user") Integer userId) {
	...
	/**
	 * Delete specific user DELETE /rest/api/users/user/{user-id} parameters:
	 * return:
	 **/
	...
	public String deleteUsersByUserGroup(@Context ServletConfig sc, @Context HttpServletRequest httpServletRequest,
		...
		try {
			c = SqlUtils.getConnection();
			if (user == null) {
				dataProvider.deleteUsersGroups(c, group, ui.userId);
			} else {
				dataProvider.deleteUsersFromUserGroups(c, user, group, ui.userId);
			}
		} catch (final Exception ex) {
			logger.error("Managed error", ex);
			throw new RestWebApplicationException(Status.INTERNAL_SERVER_ERROR, ex.getMessage());
	...
	public Response getCredentialFromCas(@CookieParam("user") String user, @CookieParam("credential") String token,
		...
		try {
			...
			throw new RestWebApplicationException(Status.FORBIDDEN,
					"Vous n'avez pas les droits necessaires (ticket ?, casUrlValidation) :" + casUrlVal);
		} catch (final Exception ex) {
			logger.error("Managed error", ex);
			throw new RestWebApplicationException(Status.FORBIDDEN,
	...
	public String getNodeBySemanticTag(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @QueryParam("userrole") String userrole,
			@PathParam("portfolio-uuid") String portfolioUuid, @PathParam("semantictag") String semantictag,
			@Context ServletConfig sc, @Context HttpServletRequest httpServletRequest,
			@HeaderParam("Accept") String accept) {
		if (!isUUID(portfolioUuid)) {
			logger.error("isUUID({}) is false", portfolioUuid);
	...
	public String getNodeRights(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @PathParam("node-id") String nodeUuid, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest, @HeaderParam("Accept") String accept,
			@QueryParam("user") Integer userId) {
		if (!isUUID(nodeUuid)) {
			logger.error("isUUID({}) is false", nodeUuid);
	...
	public String getNodesBySemanticTag(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @PathParam("portfolio-uuid") String portfolioUuid,
	...
	public Object getPortfolio(@CookieParam("user") String user, @CookieParam("credential") String token,
			...
			@QueryParam("userrole") String userrole, @QueryParam("resources") String resource,
	...
	public String getPortfolios(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("userrole") String userrole, @QueryParam("group") int groupId, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest, @HeaderParam("Accept") String accept,
		...
		try {
			...
			try {
				if (BooleanUtils.isFalse(BooleanUtils.toBooleanObject(project))) {
					portfolioProject = false;
				} else if (BooleanUtils.toBoolean(project)) {
			...
			if (portfolioCode != null) {
				returnValue = dataProvider.getPortfolioByCode(c, new MimeType("text/xml"), portfolioCode, ui.userId,
				...
				{
					returnValue = dataProvider.getPortfolios(c, new MimeType("text/xml"), ui.userId, groupId, userrole,
							portfolioActive, ui.subId, portfolioProject, portfolioProjectId, countOnly, search)
							.toString();
				}
	...
	public String getRightsGroup(@CookieParam("user") String user, @CookieParam("credential") String token,
			...
			@QueryParam("user") Integer queryuser, @QueryParam("role") String role) {
		if (!isUUID(portfolio)) {
	...
	public Response logoutGET(@Context ServletConfig sc, @Context HttpServletRequest httpServletRequest,
		...
		if (session != null) {
			fromshibe = (Integer) session.getAttribute("fromshibe");
		}
		if (session != null) {
			session.invalidate();
		}
	...
	public String postCopyNode(String xmlNode, @CookieParam("user") String user,
		...
		try {
			...
			if ("Selection non existante.".equals(returnValue)) {
	...
	public Response postCredentialFromCas(String content, @CookieParam("user") String user,
			...
			@Context HttpServletRequest httpServletRequest) throws IllegalAccessException {
	...
	@POST
	@Produces(MediaType.APPLICATION_XML)
	public Response postCredentialGroup(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest) {
		httpServletRequest.getSession(true);
	...
	@POST
	@Produces(MediaType.APPLICATION_XML)
	public Response postCredentialGroupLabel(@CookieParam("user") String user, @CookieParam("credential") String token,
			@QueryParam("group") int groupId, @Context ServletConfig sc, @Context HttpServletRequest httpServletRequest,
	...
	public String postGroupsUsers(@CookieParam("user") String user, @CookieParam("credential") String token,
		...
		try {
			...
			throw new RestWebApplicationException(Status.FORBIDDEN,
					ui.userId + " ne fait pas parti du groupe " + groupId);
	...
	public String postNodeFromModelBySemanticTag(String xmlNode, @CookieParam("user") String user,
			@CookieParam("credential") String token, @QueryParam("group") int groupId,
			@QueryParam("userrole") String userrole, @PathParam("node-id") String nodeUuid,
			@PathParam("semantic-tag") String semantictag, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest, @QueryParam("user") Integer userId) {
		if (!isUUID(nodeUuid)) {
			logger.error("isUUID({})  is false", nodeUuid);
			throw new RestWebApplicationException(Status.BAD_REQUEST, "Not UUID");
	...
	public String postPortfolio(String xmlPortfolio, @CookieParam("user") String user,
		...
		try {
			...
			return dataProvider.postPortfolio(c, new MimeType("text/xml"), new MimeType("text/xml"), xmlPortfolio,
		...
		try {
			...
			returnValue = dataProvider
					.postPortfolioZip(c, new MimeType("text/xml"), new MimeType("text/xml"), httpServletRequest,
							uploadedInputStream, ui.userId, groupId, modelId, ui.subId, instantiate, projectName)
					.toString();
		} catch (final RestWebApplicationException e) {
			logger.error("Managed error", e);
			throw e;
	...
	public String putNodeMetadata(String xmlNode, @CookieParam("user") String user,
		...
		try {
			...
			if (MysqlDataProvider.DATABASE_FALSE.equals(returnValue)) {
				errorLog.error(String.format(logformat, "ERR", nodeUuid, "metadata", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				editLog.error(String.format(logformat, "ERR", nodeUuid, "metadata", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				throw new RestWebApplicationException(Status.FORBIDDEN, "Vous n'avez pas les droits necessaires");
			}

			editLog.info(String.format(logformat, "OK", nodeUuid, "metadata", ui.userId, timeFormat,
					httpServletRequest.getRemoteAddr(), xmlNode));
			return returnValue;
		} catch (final RestWebApplicationException ex) {
			logger.error("Managed error", ex);
	...
	public String putNodeMetadataEpm(String xmlNode, @PathParam("nodeid") String nodeUuid,
			@QueryParam("group") int groupId, @QueryParam("info") String info, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest) {
		if (!isUUID(nodeUuid)) {
			logger.error("isUUID({}) is false", nodeUuid);
			throw new RestWebApplicationException(Status.BAD_REQUEST, "Not UUID");
		...
		try {
			...
			if (MysqlDataProvider.DATABASE_FALSE.equals(returnValue)) {
				errorLog.error(String.format(logformat, "ERR", nodeUuid, "metadataepm", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				editLog.info(String.format(logformat, "ERR", nodeUuid, "metadataepm", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				throw new RestWebApplicationException(Status.FORBIDDEN, "Vous n'avez pas les droits necessaires");
			}
			if ("erreur".equals(returnValue)) {
				errorLog.error(String.format(logformat, "NMOD", nodeUuid, "metadataepm", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				editLog.info(String.format(logformat, "NMOD", nodeUuid, "metadataepm", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				throw new RestWebApplicationException(Status.NOT_MODIFIED, "Erreur");
			}

			editLog.info(String.format(logformat, "OK", nodeUuid, "metadataepm", ui.userId, timeFormat,
					httpServletRequest.getRemoteAddr(), xmlNode));
		...
		try {
			...
			if (MysqlDataProvider.DATABASE_FALSE.equals(returnValue)) {
				errorLog.error(String.format(logformat, "ERR", nodeUuid, "metadatawad", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				editLog.info(String.format(logformat, "ERR", nodeUuid, "metadatawad", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				throw new RestWebApplicationException(Status.FORBIDDEN, "Vous n'avez pas les droits necessaires");
			}

			editLog.info(String.format(logformat, "OK", nodeUuid, "metadatawad", ui.userId, timeFormat,
					httpServletRequest.getRemoteAddr(), xmlNode));
	...
	public String putNodeNodeContext(String xmlNode, @CookieParam("user") String user,
			@CookieParam("credential") String token, @QueryParam("group") int groupId,
			@QueryParam("userrole") String userrole, @QueryParam("info") String info,
			@PathParam("nodeid") String nodeUuid, @Context ServletConfig sc,
			@Context HttpServletRequest httpServletRequest) {
		if (!isUUID(nodeUuid)) {
			logger.error("isUUID({}) is false", nodeUuid);
		...
		try {
			...
			if (MysqlDataProvider.DATABASE_FALSE.equals(returnValue)) {
				errorLog.error(String.format(logformat, "ERR", nodeUuid, "nodecontext", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				editLog.info(String.format(logformat, "ERR", nodeUuid, "nodecontext", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				throw new RestWebApplicationException(Status.FORBIDDEN, "Vous n'avez pas les droits necessaires");
			}

			if (editLog != null) {
				editLog.info(String.format(logformat, "OK", nodeUuid, "nodecontext", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
			}
		...
		try {
			...
			if (MysqlDataProvider.DATABASE_FALSE.equals(returnValue)) {
				errorLog.error(String.format(logformat, "ERR", nodeUuid, "noderesource", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				editLog.info(String.format(logformat, "ERR", nodeUuid, "noderesource", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlNode));
				throw new RestWebApplicationException(Status.FORBIDDEN, "Vous n'avez pas les droits necessaires");
			}

			editLog.info(String.format(logformat, "OK", nodeUuid, "noderesource", ui.userId, timeFormat,
					httpServletRequest.getRemoteAddr(), xmlNode));
	...
	public String putResource(String xmlResource, @CookieParam("user") String user,
		...
		try {
			...
			editLog.info(String.format(logformat, "OK", nodeParentUuid, "resource", ui.userId, timeFormat,
			...
			try {
				errorLog.error(String.format(logformat, "ERR", nodeParentUuid, "resource", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlResource));
				editLog.info(String.format(logformat, "ERR", nodeParentUuid, "resource", ui.userId, timeFormat,
						httpServletRequest.getRemoteAddr(), xmlResource));
			} catch (final Exception exex) {
